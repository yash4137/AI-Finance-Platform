...
function Calendar({
  ...
  return <DayPicker
    ...
    classNames={{
      ...
      selected: "bg-primary text-primary-foreground hover:!bg-primary !text-white hover:text-primary-foreground focus:bg-primary focus:text-primary-foreground",
    ...
    components={{
      Chevron: ({ orientation, ...props2 }) => {
        ...
        return <Icon className="size-4" {...props2} />;
      }
    }}
    {...props}
  />;
