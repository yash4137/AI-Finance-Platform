...
const ScheduleReportForm = ({
  ...
  return <div className="pt-5 px-2.5">
      <Form {...form}>
  ...
  />
    ...
    /* Disabled overlay */
              ...
              {!form.watch("isEnabled") && <div className="absolute inset-0 bg-white/50 dark:bg-black/50 z-10" />}
            </div>
...
var stdin_default = ScheduleReportForm;
export {
